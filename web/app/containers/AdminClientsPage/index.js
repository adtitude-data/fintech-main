...
import makeSelectAdminClientsPage from './selectors';
...
export function AdminClientsPage() {
  useInjectReducer({ key: 'adminClientsPage', reducer });
  useInjectSaga({ key: 'adminClientsPage', saga });
  ...
  useEffect(() => {
    api.getAdminNewClients().then( (data) => {
      var d = [] ;
  ...
  function AddNewClientCallback(dataToInject , edit) {
    if(dataToInject != undefined){
      if(edit){
        ...
        console.log('ClientListingData',ClientListingData)
      }else{
      ...
      <AppContainer>
        <div className="main-page">
          <div className="content-center">
                <AddNewClient onChange={AddNewClientCallback} view={ClientEditView} edit={ClientToEditId} />
            </div>
        </div>
      </AppContainer>
    );
    ...
    return (
      <AppContainer>
        ...
        <div className="content-center">
              ...
              <AdminListClients agents={ClientListingData} onChange={ActionsClientCallback} />
          </div>
...
AdminClientsPage.propTypes = {
  dispatch: PropTypes.func.isRequired,
};

const mapStateToProps = createStructuredSelector({
  adminClientsPage: makeSelectAdminClientsPage(),
});
