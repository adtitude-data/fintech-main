...
function AddNewClientAccount(props) {
  ...
  function _handleSubmit (e){
    ...
    api.addAdminNewClient(inputs , canEdit , props.edit ).then( (data) => {
      ...
      if(data.errors){
        ...
        data = data.data;
        var message = 'Account has been added successfuly.';
        if(canEdit) message = 'Account has been updated successfuly.';
                ...
                <div className="row">
                  ...
                  <div className="col-12">
                    <div className="form-group">
                      ...
                      {/* <input type="hidden"  name="oldAgentId"  value={inputs.oldAgentId || ""}  onChange={_handleChange}  required /> */}
                      <select
  ...
  AddNewClientAccount.propTypes = {};

  export default withRouter (AddNewClientAccount);
